package com.example.todotool.config;

import com.example.todotool.jwt.JwtRequestFilter;
import com.example.todotool.jwt.JwtUnAuthorizedResponse;
import com.example.todotool.service.UserPrincipalService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/authenticate", "/rest/user/register").permitAll()
